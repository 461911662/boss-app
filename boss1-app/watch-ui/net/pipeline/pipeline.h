/****************************************************************************
 * vendor/boss/app/boss1-app/watch-ui/net/pipeline/pipeline.h
 *
...
#ifndef __WATCH_UI_NET_PIPELINE_H
#define __WATCH_UI_NET_PIPELINE_H
...
struct node_wait_event {
    sq_entry_t entry;
    int event_id;               /* WiFi event ID to wait for */
};
...
typedef struct pipeline_node {
    ...
    void *ctx;                  /* Pipeline's user context */
...
typedef struct pipeline {
    ...
    void (*on_error)(struct pipeline *p, int error_code, void *user_data);
    void *user_data;
...
typedef struct {
    ...
    volatile int32_t spinlock;    /* For signal handler synchronization */
    pipeline_t *pipelines;
} pipeline_manager_t;

/* Global pipeline manager instance - defined in pipeline.c */
...
#endif /* __WATCH_UI_NET_PIPELINE_H */
