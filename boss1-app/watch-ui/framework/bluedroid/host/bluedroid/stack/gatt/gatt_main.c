...
void gatt_init (void)
{
    ...
    gatt_cb.p_clcb_list = osi_list_new(osi_free_func);
    gatt_cb.p_tcb_list  = osi_list_new(osi_free_func);
...
void gatt_free(void)
{
    ...
    osi_list_free(gatt_cb.p_tcb_list);
    osi_list_free(gatt_cb.p_clcb_list);
