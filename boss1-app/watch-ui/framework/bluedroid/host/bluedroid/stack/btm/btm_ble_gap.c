...
{
    osi_sem_new(&adv_enable_sem, 0, 0);
    osi_sem_new(&adv_data_sem, 0, 0);
    osi_sem_new(&adv_param_sem, 0, 0);
    osi_sem_new(&scan_enable_sem, 0, 0);
    osi_sem_new(&scan_param_sem, 0, 0);
}
