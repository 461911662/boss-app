...
#else /* else (UC_BT_HFP_AG_ENABLED == TRUE) || (UC_BT_HFP_CLIENT_ENABLED == TRUE) */

#define BTC_HF_CLIENT_INCLUDED      FALSE
#define BTC_HF_INCLUDED             FALSE
...
#if defined(VND_BT_JV_BTA_L2CAP)
...
#if defined(BT_MULTI_CONNECTION_ENBALE) && (defined(CONFIG_IDF_TARGET_ESP32C3) || defined(CONFIG_IDF_TARGET_ESP32S3))
