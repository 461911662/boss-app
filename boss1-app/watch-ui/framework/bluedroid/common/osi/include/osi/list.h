...
// similar with osi_list_free_node, this function doesn't free the node data
...
// instance. If a free function was specified in |osi_list_new|, it will be called back
...
// same state it was in after |osi_list_new|. |list| may not be NULL.
