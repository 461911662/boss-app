...
static inline int sys_dosi_list_is_empty(sys_dlist_t *list)
{
...
{
    return sys_dosi_list_is_empty(list) ? NULL : list->head;
}
...
{
    return sys_dosi_list_is_empty(list) ? NULL : list->tail;
}
...
{
    if (sys_dosi_list_is_empty(list)) {
        sys_dlist_append(list, node);
    } else {
